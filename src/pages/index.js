...
import { useChinese, LangSwitch } from '@/components/LangSwitch'
import { Creator } from '@/components/home/Creator'
import { Alert } from '@/components/home/Alert'
import { Unify } from '@/components/home/Unify'
import { Open } from '@/components/home/Open'
import { Extend } from '@/components/home/Extend'
  ...
  return (
    ...
    >
      <span className="text-gray-900">
        ...
        docker run -d --name=datav -p 3000:3000 -p 3001:3001 opendatav/datav
      </span>
    ...
    <div className="space-y-20 sm:space-y-32 md:space-y-40 lg:space-y-44 overflow-hidden">
      <Head>
        <meta
          key="twitter:title"
          name="twitter:title"
          content="Datav - Visualize your data"
        />
        <meta
          key="og:title"
          property="og:title"
        ...
        />
        <title>Datav - Visualize your data</title>
      </Head>
      <header className="relative z-10 max-w-screen-lg xl:max-w-screen-xl mx-auto">
        <div className="px-4 sm:px-6 md:px-8 mb-14 sm:mb-20 xl:mb-8">
          <div className="border-b border-gray-200 py-6 flex items-center justify-between mb-16 sm:mb-10 -mx-4 px-4 sm:mx-0 sm:px-0">
            <Search isChinese={isChinese} />
            <div className="flex space-x-6 sm:space-x-5">
              {/* <NextLink href="/docs">
                <a className="text-base leading-6 font-medium hover:text-gray-600 transition-colors duration-200">
                  ...
                  <span className="hidden sm:inline">{isChinese === true ? '文档' : 'Documentation'}</span>
                </a>
              </NextLink> */}
              <a
          ...
          <div className="flex flex-wrap space-y-4 sm:space-y-0 sm:space-x-4 text-center">
            <NextLink href={isChinese ? '/docs-cn' : '/docs'}>
              <a className="w-full sm:w-auto flex-none bg-gray-900 hover:bg-gray-700 text-white text-lg leading-6 font-semibold py-3 px-6 border border-transparent rounded-xl focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-gray-900 focus:outline-none transition-colors duration-200">
               {isChinese === true ? '快速开始' : 'Get started'} 
              </a>
            </NextLink>
            <NpmInstallButton />
          </div>
      ...
      <Testimonials isChinese={isChinese}/>
